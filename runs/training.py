...
def train(args):
    ...
    shutil.copy('models/vipseg_learner.py', args.log_dir)
    shutil.copy('models/vipseg.py', args.log_dir)
    shutil.copy('models/encoder.py', args.log_dir)

    print_trainable_params(PL.model, logger, "All training")
    print_trainable_params(PL.model.encoder, logger, "Encoder")
    print_trainable_params(PL.model.vip_module, logger, "VIP")
    print_trainable_params(PL.model.gating_network, logger, "Gating Network")
    ...
    TRAIN_DATASET = MyDataset(args.data_path, args.dataset, cvfold=args.cvfold, num_episode=args.n_iters,
                              ...
                              way_ratio=args.way_pcratio, way_num=args.way_pcnum, random_sample=args.random_sample)
