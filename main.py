...
if __name__ == '__main__':
    ...
    #data
    parser.add_argument('--model', type=str, default='segnn', choices=['vipseg', 'vipseg_eval'])
    ...
    parser.add_argument('--random_sample', action='store_true', help='Random sampling for points in each scene')
